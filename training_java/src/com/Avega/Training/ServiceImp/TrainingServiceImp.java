...
public class TrainingServiceImp implements TrainingService{
	...
	public void findTrainingOfThisMonth(Date date) {
		...
		for(Training tra : trainingList) {
			int month = tra.getStart_date().getMonth();
			if(month == date.getMonth()) {	
				training.setTraining_id(tra.getTraining_id());
				training.setDescription(tra.getDescription());
				training.setStart_date(tra.getStart_date());
				training.setEnd_date(tra.getEnd_date());
				training.setRequestor_id(tra.getRequestor_id());
				training.setTrainer(tra.getTrainer());
				training.setSkill(tra.getSkill());
